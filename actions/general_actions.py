...
class GeneralActions:
    def __init__(self, page):
        """Initialize general actions with the page object"""
        self.page = page
        self.general_page = GeneralPage(page)

    def click_button_by_span_text(self, span_text: str):
        """Click on a button that contains a span with the given text"""
    ...
    def verify_span_text(self, expected_text):
        """Verify that a specific span contains the expected text"""
